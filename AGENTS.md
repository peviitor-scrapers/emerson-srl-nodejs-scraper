...
## Project
Emerson scraper for peviitor.ro (Node.js, ESM, Jest)

## 🌱 This Repo Is a Derived Scraper
This repo is a **derived scraper** for EMERSON SRL, based on the [epam-systems-international-srl-nodejs-scraper](https://github.com/sebiboga/epam-systems-international-srl-nodejs-scraper) template.
...
```bash
gh run view <RUN_ID> --repo sebiboga/emerson-srl-nodejs-scraper --json status -q .status
```
...
# E2E tests (real Emerson API, SOLR conditional)
npm run test:e2e
...
- `tests/validate-emerson-jobs.js` — CI fast validator (HEAD only); thin wrapper over src/job-validator.js + solr.js
