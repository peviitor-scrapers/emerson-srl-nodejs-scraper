...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Emerson") |
| group        | string   | Parent company group (e.g. "Emerson") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/peviitor-scrapers/emerson-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)