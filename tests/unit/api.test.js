...
describe('scraper/api.js', () => {
  ...
  describe('querySOLR', () => {
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.querySOLR('18284762')).rejects.toThrow('API jobs query error: 500');
    });
  });
  ...
  describe('deleteJobsByCIF', () => {
    ...
    it('should throw on HTTP error', async () => {
      ...
      await expect(solr.deleteJobsByCIF('18284762')).rejects.toThrow('API jobs delete error: 500');
    });
  });
